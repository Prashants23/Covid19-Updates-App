  ...
  render() {
    ...
    return (
      <View style={[styles.mainContainer]}>
        {this.props.TotalCases.length === 0 ? (
          <Text>loading...</Text>
        ) : (
          <View style={[styles.mainContainer]}>
            ...
            <ScrollView style={{width: '98%'}}>
              ...
              <View style={[styles.moreDetails]}>
                ...
                <View
                  style={{height: 2, width: '90%', backgroundColor: 'white'}}
                />
                <View>
              ...
              <Text style={[styles.dataTextStyles]}>
                ...
                {this.props.TotalCases.last_total_recovered_cases}
                  ...
                  <Text style={[styles.dataTextStyles]}>
                    Passengers Screened:{' '}
                    {this.props.TotalCases.passengers_screened}
                  </Text>
                </View>
              </View>
              <View
